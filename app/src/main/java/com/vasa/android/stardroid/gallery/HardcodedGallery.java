...
package com.vasa.android.stardroid.gallery;
...
public class HardcodedGallery implements Gallery {
  ...
  private ArrayList<GalleryImage> createImages() {
    ...
    add(galleryImages, R.drawable.sc1,R.string.sc1,R.string.sc1);
    add(galleryImages, R.drawable.sc2,R.string.sc2,R.string.sc2);
    add(galleryImages, R.drawable.sc3,R.string.sc3,R.string.sc3);
    add(galleryImages, R.drawable.sc4,R.string.sc4,R.string.sc4);
    add(galleryImages, R.drawable.sc5,R.string.sc5,R.string.sc5);
