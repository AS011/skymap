...
import com.vasa.android.stardroid.About_the_devloper;
import com.vasa.android.stardroid.About_us;
import com.vasa.android.stardroid.ApplicationConstants;
import com.vasa.android.stardroid.Join_us;
import com.vasa.android.stardroid.Our_services;
...
import com.vasa.android.stardroid.activities.util.ActivityLightLevelChanger;
import com.vasa.android.stardroid.activities.util.ActivityLightLevelChanger.NightModeable;
import com.vasa.android.stardroid.activities.util.ActivityLightLevelManager;
import com.vasa.android.stardroid.activities.util.FullscreenControlsManager;
import com.vasa.android.stardroid.activities.util.GooglePlayServicesChecker;
import com.vasa.android.stardroid.base.Lists;
...
import com.vasa.android.stardroid.renderer.RendererController;
import com.vasa.android.stardroid.renderer.SkyRenderer;
import com.vasa.android.stardroid.renderer.util.AbstractUpdateClosure;
import com.vasa.android.stardroid.search.SearchResult;
import com.vasa.android.stardroid.touch.DragRotateZoomGestureDetector;
import com.vasa.android.stardroid.touch.GestureInterpreter;
import com.vasa.android.stardroid.touch.MapMover;
import com.vasa.android.stardroid.units.GeocentricCoordinates;
import com.vasa.android.stardroid.units.Vector3;
import com.vasa.android.stardroid.util.Analytics;
import com.vasa.android.stardroid.util.MathUtil;
import com.vasa.android.stardroid.util.MiscUtil;
import com.vasa.android.stardroid.util.SensorAccuracyMonitor;
import com.vasa.android.stardroid.views.ButtonLayerView;
...
public class DynamicStarMapActivity extends InjectableActivity
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      case R.id.about_the_devloper: startActivity(new Intent(this, About_the_devloper.class)); break;
      case R.id.vasa: startActivity(new Intent(this, About_the_devloper.class));break;
      case R.id.our_services: startActivity(new Intent(this, Our_services.class)); break;
      case R.id.about_us:startActivity(new Intent(this, About_us.class)); break;
      case R.id.join_us:startActivity(new Intent(this, Join_us.class)); break;
