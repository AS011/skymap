...
public final class SourceProto {
  ...
  public static final class GeocentricCoordinatesProto extends
    ...
    public static SourceProto.GeocentricCoordinatesProto parseFrom(
    ...
    public static SourceProto.GeocentricCoordinatesProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SourceProto.GeocentricCoordinatesProto parseFrom(
    ...
    public static SourceProto.GeocentricCoordinatesProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SourceProto.GeocentricCoordinatesProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SourceProto.GeocentricCoordinatesProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(SourceProto.GeocentricCoordinatesProto prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          SourceProto.GeocentricCoordinatesProto, Builder> {
      private SourceProto.GeocentricCoordinatesProto result;
      
      // Construct using SourceProto.GeocentricCoordinatesProto.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new SourceProto.GeocentricCoordinatesProto();
        return builder;
      }
      
      protected SourceProto.GeocentricCoordinatesProto internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new SourceProto.GeocentricCoordinatesProto();
        return this;
      }
      ...
      public SourceProto.GeocentricCoordinatesProto getDefaultInstanceForType() {
        return SourceProto.GeocentricCoordinatesProto.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public SourceProto.GeocentricCoordinatesProto build() {
      ...
      private SourceProto.GeocentricCoordinatesProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public SourceProto.GeocentricCoordinatesProto buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        SourceProto.GeocentricCoordinatesProto returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(SourceProto.GeocentricCoordinatesProto other) {
        if (other == SourceProto.GeocentricCoordinatesProto.getDefaultInstance()) return this;
  ...
  public static final class PointElementProto extends
    ...
    public SourceProto.GeocentricCoordinatesProto getLocation() { return location_; }
    ...
    private SourceProto.Shape shape_;
    public boolean hasShape() { return hasShape; }
    public SourceProto.Shape getShape() { return shape_; }
    
    private void initFields() {
      location_ = SourceProto.GeocentricCoordinatesProto.getDefaultInstance();
      shape_ = SourceProto.Shape.CIRCLE;
    }
    public final boolean isInitialized() {
      return true;
    }
    ...
    public static SourceProto.PointElementProto parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static SourceProto.PointElementProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SourceProto.PointElementProto parseFrom(
    ...
    public static SourceProto.PointElementProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static SourceProto.PointElementProto parseFrom(
    ...
    public static SourceProto.PointElementProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static SourceProto.PointElementProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(SourceProto.PointElementProto prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          SourceProto.PointElementProto, Builder> {
      private SourceProto.PointElementProto result;
      
      // Construct using SourceProto.PointElementProto.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new SourceProto.PointElementProto();
        return builder;
      }
      
      protected SourceProto.PointElementProto internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new SourceProto.PointElementProto();
        return this;
      }
      ...
      public SourceProto.PointElementProto getDefaultInstanceForType() {
        return SourceProto.PointElementProto.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public SourceProto.PointElementProto build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private SourceProto.PointElementProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public SourceProto.PointElementProto buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        SourceProto.PointElementProto returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(SourceProto.PointElementProto other) {
        if (other == SourceProto.PointElementProto.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              SourceProto.GeocentricCoordinatesProto.Builder subBuilder = SourceProto.GeocentricCoordinatesProto.newBuilder();
              if (hasLocation()) {
            ...
            case 32: {
              ...
              SourceProto.Shape value = SourceProto.Shape.valueOf(rawValue);
              if (value != null) {
                setShape(value);
              }
              break;
      ...
      public Builder setLocation(SourceProto.GeocentricCoordinatesProto value) {
        if (value == null) {
      ...
      public Builder setLocation(SourceProto.GeocentricCoordinatesProto.Builder builderForValue) {
        result.hasLocation = true;
        result.location_ = builderForValue.build();
        return this;
      }
      public Builder mergeLocation(SourceProto.GeocentricCoordinatesProto value) {
        if (result.hasLocation() &&
            result.location_ != SourceProto.GeocentricCoordinatesProto.getDefaultInstance()) {
          result.location_ =
            SourceProto.GeocentricCoordinatesProto.newBuilder(result.location_).mergeFrom(value).buildPartial();
        } else {
          result.location_ = value;
        }
        result.hasLocation = true;
      ...
      public SourceProto.Shape getShape() {
        return result.getShape();
      }
      public Builder setShape(SourceProto.Shape value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder clearShape() {
        ...
        result.shape_ = SourceProto.Shape.CIRCLE;
        return this;
      }
  ...
  public static final class LabelElementProto extends
    ...
    public static SourceProto.LabelElementProto parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static SourceProto.LabelElementProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SourceProto.LabelElementProto parseFrom(
    ...
    public static SourceProto.LabelElementProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static SourceProto.LabelElementProto parseFrom(
    ...
    public static SourceProto.LabelElementProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static SourceProto.LabelElementProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(SourceProto.LabelElementProto prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          SourceProto.LabelElementProto, Builder> {
      private SourceProto.LabelElementProto result;
      
      // Construct using SourceProto.LabelElementProto.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new SourceProto.LabelElementProto();
        return builder;
      }
      
      protected SourceProto.LabelElementProto internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new SourceProto.LabelElementProto();
        return this;
      }
      ...
      public SourceProto.LabelElementProto getDefaultInstanceForType() {
        return SourceProto.LabelElementProto.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public SourceProto.LabelElementProto build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private SourceProto.LabelElementProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public SourceProto.LabelElementProto buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        SourceProto.LabelElementProto returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(SourceProto.LabelElementProto other) {
        if (other == SourceProto.LabelElementProto.getDefaultInstance()) return this;
        if (other.hasLocation()) {
          mergeLocation(other.getLocation());
        }
        if (other.hasColor()) {
  ...
  public static final class LineElementProto extends
    ...
    private java.util.List<SourceProto.GeocentricCoordinatesProto> vertex_ =
      java.util.Collections.emptyList();
    public java.util.List<SourceProto.GeocentricCoordinatesProto> getVertexList() {
      return vertex_;
    }
    public int getVertexCount() { return vertex_.size(); }
    public SourceProto.GeocentricCoordinatesProto getVertex(int index) {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (SourceProto.GeocentricCoordinatesProto element : getVertexList()) {
    ...
    public static SourceProto.LineElementProto parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static SourceProto.LineElementProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SourceProto.LineElementProto parseFrom(
    ...
    public static SourceProto.LineElementProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static SourceProto.LineElementProto parseFrom(
    ...
    public static SourceProto.LineElementProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static SourceProto.LineElementProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(SourceProto.LineElementProto prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          SourceProto.LineElementProto, Builder> {
      private SourceProto.LineElementProto result;
      
      // Construct using SourceProto.LineElementProto.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new SourceProto.LineElementProto();
        return builder;
      }
      
      protected SourceProto.LineElementProto internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new SourceProto.LineElementProto();
        return this;
      }
      ...
      public SourceProto.LineElementProto getDefaultInstanceForType() {
        return SourceProto.LineElementProto.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public SourceProto.LineElementProto build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private SourceProto.LineElementProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public SourceProto.LineElementProto buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        ...
        SourceProto.LineElementProto returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(SourceProto.LineElementProto other) {
        if (other == SourceProto.LineElementProto.getDefaultInstance()) return this;
        if (other.hasColor()) {
          setColor(other.getColor());
        }
        ...
        if (!other.vertex_.isEmpty()) {
          if (result.vertex_.isEmpty()) {
            result.vertex_ = new java.util.ArrayList<SourceProto.GeocentricCoordinatesProto>();
          }
      ...
      public Builder setVertex(int index, SourceProto.GeocentricCoordinatesProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setVertex(int index, SourceProto.GeocentricCoordinatesProto.Builder builderForValue) {
        result.vertex_.set(index, builderForValue.build());
        return this;
      }
      public Builder addVertex(SourceProto.GeocentricCoordinatesProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.vertex_.isEmpty()) {
      ...
      public Builder addVertex(SourceProto.GeocentricCoordinatesProto.Builder builderForValue) {
        if (result.vertex_.isEmpty()) {
          result.vertex_ = new java.util.ArrayList<SourceProto.GeocentricCoordinatesProto>();
        }
      ...
      public Builder addAllVertex(
          java.lang.Iterable<? extends SourceProto.GeocentricCoordinatesProto> values) {
        if (result.vertex_.isEmpty()) {
          result.vertex_ = new java.util.ArrayList<SourceProto.GeocentricCoordinatesProto>();
        }
  ...
  public static final class AstronomicalSourceProto extends
    ...
    public SourceProto.GeocentricCoordinatesProto getSearchLocation() { return searchLocation_; }
    ...
    private java.util.List<SourceProto.PointElementProto> point_ =
      java.util.Collections.emptyList();
    public java.util.List<SourceProto.PointElementProto> getPointList() {
      return point_;
    }
    public int getPointCount() { return point_.size(); }
    public SourceProto.PointElementProto getPoint(int index) {
      return point_.get(index);
    }
    
    // repeated .stardroid_source.LabelElementProto label = 6;
    public static final int LABEL_FIELD_NUMBER = 6;
    private java.util.List<SourceProto.LabelElementProto> label_ =
      java.util.Collections.emptyList();
    public java.util.List<SourceProto.LabelElementProto> getLabelList() {
      return label_;
    }
    public int getLabelCount() { return label_.size(); }
    public SourceProto.LabelElementProto getLabel(int index) {
      return label_.get(index);
    }
    
    // repeated .stardroid_source.LineElementProto line = 7;
    public static final int LINE_FIELD_NUMBER = 7;
    private java.util.List<SourceProto.LineElementProto> line_ =
      java.util.Collections.emptyList();
    public java.util.List<SourceProto.LineElementProto> getLineList() {
      return line_;
    }
    public int getLineCount() { return line_.size(); }
    public SourceProto.LineElementProto getLine(int index) {
      return line_.get(index);
    }
    
    private void initFields() {
      searchLocation_ = SourceProto.GeocentricCoordinatesProto.getDefaultInstance();
    }
    public final boolean isInitialized() {
      return true;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (SourceProto.PointElementProto element : getPointList()) {
        output.writeMessage(5, element);
      }
      for (SourceProto.LabelElementProto element : getLabelList()) {
        output.writeMessage(6, element);
      }
      for (SourceProto.LineElementProto element : getLineList()) {
    ...
    public static SourceProto.AstronomicalSourceProto parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static SourceProto.AstronomicalSourceProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SourceProto.AstronomicalSourceProto parseFrom(
    ...
    public static SourceProto.AstronomicalSourceProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static SourceProto.AstronomicalSourceProto parseFrom(
    ...
    public static SourceProto.AstronomicalSourceProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static SourceProto.AstronomicalSourceProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(SourceProto.AstronomicalSourceProto prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          SourceProto.AstronomicalSourceProto, Builder> {
      private SourceProto.AstronomicalSourceProto result;
      
      // Construct using SourceProto.AstronomicalSourceProto.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new SourceProto.AstronomicalSourceProto();
        return builder;
      }
      
      protected SourceProto.AstronomicalSourceProto internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new SourceProto.AstronomicalSourceProto();
        return this;
      }
      ...
      public SourceProto.AstronomicalSourceProto getDefaultInstanceForType() {
        return SourceProto.AstronomicalSourceProto.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public SourceProto.AstronomicalSourceProto build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private SourceProto.AstronomicalSourceProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public SourceProto.AstronomicalSourceProto buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        ...
        SourceProto.AstronomicalSourceProto returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(SourceProto.AstronomicalSourceProto other) {
        if (other == SourceProto.AstronomicalSourceProto.getDefaultInstance()) return this;
        ...
        if (!other.point_.isEmpty()) {
          if (result.point_.isEmpty()) {
            result.point_ = new java.util.ArrayList<SourceProto.PointElementProto>();
          }
          result.point_.addAll(other.point_);
        }
        if (!other.label_.isEmpty()) {
          if (result.label_.isEmpty()) {
            result.label_ = new java.util.ArrayList<SourceProto.LabelElementProto>();
          }
          result.label_.addAll(other.label_);
        }
        if (!other.line_.isEmpty()) {
          if (result.line_.isEmpty()) {
            result.line_ = new java.util.ArrayList<SourceProto.LineElementProto>();
          }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 42: {
              SourceProto.PointElementProto.Builder subBuilder = SourceProto.PointElementProto.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addPoint(subBuilder.buildPartial());
              break;
            }
            case 50: {
              SourceProto.LabelElementProto.Builder subBuilder = SourceProto.LabelElementProto.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addLabel(subBuilder.buildPartial());
              break;
            }
            case 58: {
              SourceProto.LineElementProto.Builder subBuilder = SourceProto.LineElementProto.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
      ...
      public Builder setSearchLocation(SourceProto.GeocentricCoordinatesProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setSearchLocation(SourceProto.GeocentricCoordinatesProto.Builder builderForValue) {
        result.hasSearchLocation = true;
        result.searchLocation_ = builderForValue.build();
        return this;
      }
      public Builder mergeSearchLocation(SourceProto.GeocentricCoordinatesProto value) {
        if (result.hasSearchLocation() &&
            result.searchLocation_ != SourceProto.GeocentricCoordinatesProto.getDefaultInstance()) {
          result.searchLocation_ =
            SourceProto.GeocentricCoordinatesProto.newBuilder(result.searchLocation_).mergeFrom(value).buildPartial();
        } else {
          result.searchLocation_ = value;
        }
        result.hasSearchLocation = true;
      ...
      public Builder setPoint(int index, SourceProto.PointElementProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setPoint(int index, SourceProto.PointElementProto.Builder builderForValue) {
        result.point_.set(index, builderForValue.build());
        return this;
      }
      public Builder addPoint(SourceProto.PointElementProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.point_.isEmpty()) {
      ...
      public Builder addPoint(SourceProto.PointElementProto.Builder builderForValue) {
        if (result.point_.isEmpty()) {
          result.point_ = new java.util.ArrayList<SourceProto.PointElementProto>();
        }
      ...
      public Builder addAllPoint(
          java.lang.Iterable<? extends SourceProto.PointElementProto> values) {
        if (result.point_.isEmpty()) {
          result.point_ = new java.util.ArrayList<SourceProto.PointElementProto>();
        }
      ...
      public Builder setLabel(int index, SourceProto.LabelElementProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setLabel(int index, SourceProto.LabelElementProto.Builder builderForValue) {
        result.label_.set(index, builderForValue.build());
        return this;
      }
      public Builder addLabel(SourceProto.LabelElementProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.label_.isEmpty()) {
      ...
      public Builder addLabel(SourceProto.LabelElementProto.Builder builderForValue) {
        if (result.label_.isEmpty()) {
          result.label_ = new java.util.ArrayList<SourceProto.LabelElementProto>();
        }
      ...
      public Builder addAllLabel(
          java.lang.Iterable<? extends SourceProto.LabelElementProto> values) {
        if (result.label_.isEmpty()) {
          result.label_ = new java.util.ArrayList<SourceProto.LabelElementProto>();
        }
      ...
      public Builder setLine(int index, SourceProto.LineElementProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setLine(int index, SourceProto.LineElementProto.Builder builderForValue) {
        result.line_.set(index, builderForValue.build());
        return this;
      }
      public Builder addLine(SourceProto.LineElementProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.line_.isEmpty()) {
      ...
      public Builder addLine(SourceProto.LineElementProto.Builder builderForValue) {
        if (result.line_.isEmpty()) {
          result.line_ = new java.util.ArrayList<SourceProto.LineElementProto>();
        }
      ...
      public Builder addAllLine(
          java.lang.Iterable<? extends SourceProto.LineElementProto> values) {
        if (result.line_.isEmpty()) {
          result.line_ = new java.util.ArrayList<SourceProto.LineElementProto>();
        }
  ...
  public static final class AstronomicalSourcesProto extends
    ...
    private java.util.List<SourceProto.AstronomicalSourceProto> source_ =
      java.util.Collections.emptyList();
    public java.util.List<SourceProto.AstronomicalSourceProto> getSourceList() {
      return source_;
    }
    public int getSourceCount() { return source_.size(); }
    public SourceProto.AstronomicalSourceProto getSource(int index) {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      getSerializedSize();
      for (SourceProto.AstronomicalSourceProto element : getSourceList()) {
    ...
    public static SourceProto.AstronomicalSourcesProto parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static SourceProto.AstronomicalSourcesProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SourceProto.AstronomicalSourcesProto parseFrom(
    ...
    public static SourceProto.AstronomicalSourcesProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static SourceProto.AstronomicalSourcesProto parseFrom(
    ...
    public static SourceProto.AstronomicalSourcesProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static SourceProto.AstronomicalSourcesProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(SourceProto.AstronomicalSourcesProto prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          SourceProto.AstronomicalSourcesProto, Builder> {
      private SourceProto.AstronomicalSourcesProto result;
      
      // Construct using SourceProto.AstronomicalSourcesProto.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new SourceProto.AstronomicalSourcesProto();
        return builder;
      }
      
      protected SourceProto.AstronomicalSourcesProto internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new SourceProto.AstronomicalSourcesProto();
        return this;
      }
      ...
      public SourceProto.AstronomicalSourcesProto getDefaultInstanceForType() {
        return SourceProto.AstronomicalSourcesProto.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public SourceProto.AstronomicalSourcesProto build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private SourceProto.AstronomicalSourcesProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public SourceProto.AstronomicalSourcesProto buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        ...
        SourceProto.AstronomicalSourcesProto returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(SourceProto.AstronomicalSourcesProto other) {
        if (other == SourceProto.AstronomicalSourcesProto.getDefaultInstance()) return this;
        if (!other.source_.isEmpty()) {
          if (result.source_.isEmpty()) {
            result.source_ = new java.util.ArrayList<SourceProto.AstronomicalSourceProto>();
          }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              SourceProto.AstronomicalSourceProto.Builder subBuilder = SourceProto.AstronomicalSourceProto.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
      ...
      public Builder setSource(int index, SourceProto.AstronomicalSourceProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setSource(int index, SourceProto.AstronomicalSourceProto.Builder builderForValue) {
        result.source_.set(index, builderForValue.build());
        return this;
      }
      public Builder addSource(SourceProto.AstronomicalSourceProto value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.source_.isEmpty()) {
      ...
      public Builder addSource(SourceProto.AstronomicalSourceProto.Builder builderForValue) {
        if (result.source_.isEmpty()) {
          result.source_ = new java.util.ArrayList<SourceProto.AstronomicalSourceProto>();
        }
      ...
      public Builder addAllSource(
          java.lang.Iterable<? extends SourceProto.AstronomicalSourceProto> values) {
        if (result.source_.isEmpty()) {
          result.source_ = new java.util.ArrayList<SourceProto.AstronomicalSourceProto>();
        }
