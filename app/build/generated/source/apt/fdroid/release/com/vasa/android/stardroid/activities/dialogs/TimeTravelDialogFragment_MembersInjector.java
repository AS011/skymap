...
public final class TimeTravelDialogFragment_MembersInjector implements MembersInjector<TimeTravelDialogFragment> {
  ...
  public TimeTravelDialogFragment_MembersInjector(MembersInjector<DialogFragment> supertypeInjector, Provider<DynamicStarMapActivity> parentActivityProvider) {  
  ...
  @Override
  public void injectMembers(TimeTravelDialogFragment instance) {  
    if (instance == null) {
  ...
  public static MembersInjector<TimeTravelDialogFragment> create(MembersInjector<DialogFragment> supertypeInjector, Provider<DynamicStarMapActivity> parentActivityProvider) {  
      return new TimeTravelDialogFragment_MembersInjector(supertypeInjector, parentActivityProvider);
  }
}
